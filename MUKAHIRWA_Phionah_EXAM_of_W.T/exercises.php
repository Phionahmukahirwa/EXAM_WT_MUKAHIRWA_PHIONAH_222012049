...
<section>
   <h1><u>Exercises Profile Form</u></h1>
...
<form method="post" onsubmit="return confirmInsert();">
    ...
    <label for="DifficultyLevel">DifficultyLevel:</label>
    ...
    <label for="ImageOrVideo">ImageOrVideo:</label>
    <input type="number" id="capacit" name="capacit" required><br><br>

    <label for="Instructions">Instructions:</label>
    <input type="number" id="capaci" name="capaci" required><br><br>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $connection->prepare("INSERT INTO exercises(ExerciseID, Name, Description, DifficultyLevel, AudioFile,ImageOrVideo,Instructions) VALUES (?, ?, ?, ?, ? ,?,?)");
    $stmt->bind_param("issssss", $ExerciseID, $Name, $Description, $DifficultyLevel, $AudioFile,$ImageOrVideo,$Instructions);
    // Set parameters and execute
    $ExerciseID = $_POST['driver_id'];
    $Name = $_POST['user_id'];
    $Description = $_POST['license_number'];
    $DifficultyLevel = $_POST['car_model'];
    $AudioFile = $_POST['capacity'];
    $ImageOrVideo = $_POST['capacit'];
    $Instructions = $_POST['capaci'];
...
if ($result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
        $ExerciseID = $row['ExerciseID']; // Fetch the ExerciseID
        echo "<tr>
            ...
            <td>" . $row['AudioFile'] . "</td>
            <td>" . $row['ImageOrVideo'] . "</td>
            <td>" . $row['Instructions'] . "</td>
            <td><a style='padding:4px' href='delete_exercises.php?ExerciseID=$ExerciseID'>Delete</a></td> 
            <td><a style='padding:4px' href='update_exercises.php?ExerciseID=$ExerciseID'>Update</a></td> 
        </tr>";
    }
