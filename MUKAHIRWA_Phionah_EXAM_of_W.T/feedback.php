...
<form method="post" onsubmit="return confirmInsert();">
    ...
    <label for="FeedbackContent">FeedbackContent:</label>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $connection->prepare("INSERT INTO feedback(FeedbackID, SessionID, ClientID, TherapistID, Rating,FeedbackContent,FeedbackDate) VALUES (?, ?, ?, ?, ? ,?,?)");
    $stmt->bind_param("issssss", $FeedbackID, $SessionID, $ClientID, $TherapistID, $Rating,$FeedbackContent,$FeedbackDate);
...
if ($result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        echo "<tr>
            ...
            <td><a style='padding:4px' href='delete_feedback.php?FeedbackID=$FeedbackID'>Delete</a></td> 
            <td><a style='padding:4px' href='update_feedback.php?FeedbackID=$FeedbackID'>Update</a></td> 
        </tr>";
    }
